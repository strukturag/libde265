...
#ifndef ALIGNED_32
#define ALIGNED_32(decl) decl __attribute__((aligned(32)))
#endif
...
// --- coefficient tables (same values as transform16x16_{1,2,3} / transform32x32
//     in sse-dct.cc). Each inner row is one madd pattern (a,b,a,b,...). ---

ALIGNED_32(static const int16_t) T16_1[4][8][8] = {
...
ALIGNED_32(static const int16_t) T16_2[2][4][8] = {
...
ALIGNED_32(static const int16_t) T16_3[2][2][8] = {
  {{ 83, 36, 83, 36, 83, 36, 83, 36},{ 36,-83, 36,-83, 36,-83, 36,-83}},
  {{ 64, 64, 64, 64, 64, 64, 64, 64},{ 64,-64, 64,-64, 64,-64, 64,-64}}
};

#define R8(a,b) { a,b,a,b,a,b,a,b }
ALIGNED_32(static const int16_t) T32[8][16][8] = {
  { R8(90,90),R8(90,82),R8(88,67),R8(85,46),R8(82,22),R8(78,-4),R8(73,-31),R8(67,-54),
    R8(61,-73),R8(54,-85),R8(46,-90),R8(38,-88),R8(31,-78),R8(22,-61),R8(13,-38),R8(4,-13) },
  { R8(88,85),R8(67,46),R8(31,-13),R8(-13,-67),R8(-54,-90),R8(-82,-73),R8(-90,-22),R8(-78,38),
    R8(-46,82),R8(-4,88),R8(38,54),R8(73,-4),R8(90,-61),R8(85,-90),R8(61,-78),R8(22,-31) },
  { R8(82,78),R8(22,-4),R8(-54,-82),R8(-90,-73),R8(-61,13),R8(13,85),R8(78,67),R8(85,-22),
    R8(31,-88),R8(-46,-61),R8(-90,31),R8(-67,90),R8(4,54),R8(73,-38),R8(88,-90),R8(38,-46) },
  { R8(73,67),R8(-31,-54),R8(-90,-78),R8(-22,38),R8(78,85),R8(67,-22),R8(-38,-90),R8(-90,4),
    R8(-13,90),R8(82,13),R8(61,-88),R8(-46,-31),R8(-88,82),R8(-4,46),R8(85,-73),R8(54,-61) },
  { R8(61,54),R8(-73,-85),R8(-46,-4),R8(82,88),R8(31,-46),R8(-88,-61),R8(-13,82),R8(90,13),
    R8(-4,-90),R8(-90,38),R8(22,67),R8(85,-78),R8(-38,-22),R8(-78,90),R8(54,-31),R8(67,-73) },
  { R8(46,38),R8(-90,-88),R8(38,73),R8(54,-4),R8(-90,-67),R8(31,90),R8(61,-46),R8(-88,-31),
    R8(22,85),R8(67,-78),R8(-85,13),R8(13,61),R8(73,-90),R8(-82,54),R8(4,22),R8(78,-82) },
  { R8(31,22),R8(-78,-61),R8(90,85),R8(-61,-90),R8(4,73),R8(54,-38),R8(-88,-4),R8(82,46),
    R8(-38,-78),R8(-22,90),R8(73,-82),R8(-90,54),R8(67,-13),R8(-13,-31),R8(-46,67),R8(85,-88) },
  { R8(13,4),R8(-38,-13),R8(61,22),R8(-78,-31),R8(88,38),R8(-90,-46),R8(85,54),R8(-73,-61),
    R8(54,67),R8(-31,-73),R8(4,78),R8(22,-82),R8(-46,85),R8(67,-88),R8(-82,90),R8(90,-90) }
};
#undef R8
...
static inline void idct16_core(const __m256i S[16], __m256i resL[16], __m256i resH[16]) {
  const __m256i T00=bc(T16_1[0][0]),T01=bc(T16_1[0][1]),T02=bc(T16_1[0][2]),T03=bc(T16_1[0][3]);
  const __m256i T04=bc(T16_1[0][4]),T05=bc(T16_1[0][5]),T06=bc(T16_1[0][6]),T07=bc(T16_1[0][7]);
  const __m256i T10=bc(T16_1[1][0]),T11=bc(T16_1[1][1]),T12=bc(T16_1[1][2]),T13=bc(T16_1[1][3]);
  const __m256i T14=bc(T16_1[1][4]),T15=bc(T16_1[1][5]),T16=bc(T16_1[1][6]),T17=bc(T16_1[1][7]);
  const __m256i T20=bc(T16_1[2][0]),T21=bc(T16_1[2][1]),T22=bc(T16_1[2][2]),T23=bc(T16_1[2][3]);
  const __m256i T24=bc(T16_1[2][4]),T25=bc(T16_1[2][5]),T26=bc(T16_1[2][6]),T27=bc(T16_1[2][7]);
  const __m256i T30=bc(T16_1[3][0]),T31=bc(T16_1[3][1]),T32_=bc(T16_1[3][2]),T33=bc(T16_1[3][3]);
  const __m256i T34=bc(T16_1[3][4]),T35=bc(T16_1[3][5]),T36=bc(T16_1[3][6]),T37=bc(T16_1[3][7]);
  const __m256i U00=bc(T16_2[0][0]),U01=bc(T16_2[0][1]),U02=bc(T16_2[0][2]),U03=bc(T16_2[0][3]);
  const __m256i U10=bc(T16_2[1][0]),U11=bc(T16_2[1][1]),U12=bc(T16_2[1][2]),U13=bc(T16_2[1][3]);
  const __m256i V00=bc(T16_3[0][0]),V01=bc(T16_3[0][1]),V10=bc(T16_3[1][0]),V11=bc(T16_3[1][1]);
...
static inline void idct32_vpass(__m256i S[32], int add, int shift) {
  ...
  const __m256i vr = _mm256_set1_epi32(add);
  for (int k=0;k<16;k++) {
    __m256i OL=_mm256_madd_epi16(pl[0], bc(T32[0][k]));
    __m256i OH=_mm256_madd_epi16(ph[0], bc(T32[0][k]));
    for (int g=1; g<8; g++) {
      OL=_mm256_add_epi32(OL,_mm256_madd_epi16(pl[g], bc(T32[g][k])));
      OH=_mm256_add_epi32(OH,_mm256_madd_epi16(ph[g], bc(T32[g][k])));
    }
